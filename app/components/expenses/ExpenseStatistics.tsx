...
import { ExpenseInterface, ExpenseListInterface } from '~/shared/interfaces';

const calculateSummaryStatistics = (expenses: ExpenseInterface[]) => {
...
export default function ExpenseStatistics({ expenses }: ExpenseListInterface) {
